...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);
         ...
         final  String getPlayerTwoName = getIntent().getStringExtra("playreTwo");
    ...
    private void performAction(ImageView imageView, int selectedBoxPosition){
        ...
        if (playerTurn == 1) {
            ...
            if (checkPlayerWin()){
                WinDialog winDialog  = new WinDialog(MainActivity.this,playerOneName.getText().toString() + "  WON THE MATCH",MainActivity.this);
            ...
            if (checkPlayerWin()){
                WinDialog winDialog  = new WinDialog(MainActivity.this,playerTwoName.getText().toString() + "  WON THE MATCH",MainActivity.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
    ...
    private void changePlayerTurn(int currentPlayerTurn){
        ...
        if (playerTurn==1){
            playerOneLayout.setBackgroundResource(R.drawable.border);
            playerTwoLayout.setBackgroundResource(R.drawable.dark_blue_bg_bg);
        }
        else {
            playerTwoLayout.setBackgroundResource(R.drawable.border);
            playerOneLayout.setBackgroundResource(R.drawable.dark_blue_bg_bg);
        }
    }
